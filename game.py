...
if __name__ == "__main__":
  ...
  scenario = Scenario(
    ...
    (
      Decision("Reply publicly: \"Happy to take the lead on the all-hands presentation since I drove most of the analysis.\"", [TagEnum.AMBITIOUS, TagEnum.CREDIT_TAKING], return_data="ahoj"),
  ...
  next_scenario = scenario.make_decision(0)
  print()
  print(npc)
  print(next_scenario)